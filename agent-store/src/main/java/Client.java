...
/**
 * A Client is how a RemoteDispatcher sends it's finished blobs to a remote endpoint
 */
public interface Client<R> extends Closeable, Flushable {
    ...
    /**
     * @param data Blob/Span/etc to send off to the endpoint
     ...
     */
    boolean send(R data) throws ClientException;
}
